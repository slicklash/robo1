...
FORWARD
\`\`\`
<Scene client:only="react" level="#zoom! 48; #size! 5 5; #start! 2 4; #angle! -90;" code="PIRMYN 3 DEŠINĖN PIRMYN" penDown="true" />
...
LEFT 180
\`\`\`
<Scene client:only="react" level="#zoom! 48; #size! 5 5; #start! 1 3; #angle! -90;" code="PIRMYN DEŠINĖN PIRMYN KAIRĖN 180" penDown="true" />
